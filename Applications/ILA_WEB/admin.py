...
from .FrontOffice.frontoffice_models import Inquiry, FollowUpRecord, VisitorLog
from .Academics.academics_models import (
    GlobalCategory,
    GlobalSubCategory,
    TeachingStrategy,
...
from .Finance.finance_models import (
    FinancialLedger,
    SalesRecord,
    FundPool,
    CommissionItem,
)
from .Rewards.rewards_models import ReferralRecord, TierRule
