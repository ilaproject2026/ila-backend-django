...
class PartnerCompanyViewSet(viewsets.ModelViewSet):
    queryset = PartnerCompany.objects.all().order_by("-created_at")
    serializer_class = PartnerCompanySerializer


class JobListingViewSet(viewsets.ModelViewSet):
    queryset = JobListing.objects.all().order_by("-posted_date")
...
class JobMatchViewSet(viewsets.ModelViewSet):
    queryset = JobMatch.objects.all().order_by("-matched_at")
