...
class StudyAbroadCourseViewSet(viewsets.ModelViewSet):
    queryset = StudyAbroadCourse.objects.all().order_by("-created_at")
...
class ConsultantATSTaskViewSet(viewsets.ModelViewSet):
    queryset = ConsultantATSTask.objects.all().order_by("-updated_at")
...
class CountryCategoriesAPIView(APIView):
    ...
    def get(self, request):
        ...
        db_categories = CountryTieUpCategory.objects.filter(
