...
INSTALLED_APPS = [
    ...
    'django_filters',
    'Applications',
    'Applications.ILA_APP.communication_engine',
    'Applications.ILA_APP.intake_tracking',
    'Applications.ILA_APP.job_search',
    'Applications.ILA_APP.rewards_plan',
    'Applications.ILA_APP.study_abroad',
    'Applications.ILA_APP.work_study',
    'Applications.BusinessStudio',
    'Applications.ImportExport',
    'Applications.GlobalRealEstate',
    'Applications.CorporateAdmin',
    'Applications.AIEnginHub',
    'drf_spectacular',
]
